...
public class SeleniumInteractionsSearchForContentByRegex {
    ...
    public void itShouldFindTextThatExistsInTheBody() {
        Assert.assertTrue(seleniumInteractions.searchForContent("^(Lorem).*", "i"));
    }

    @Test
    public void itShouldNotFindContentThatExistsInTheTitle() {
        Assert.assertFalse(seleniumInteractions.searchForContent("^(test).*?(search)$", "i"));
    }

    @Test
    public void itShouldNotFindHTMLTags() {
        Assert.assertFalse(seleniumInteractions.searchForContent("<.*?>", ""));
    }
}
